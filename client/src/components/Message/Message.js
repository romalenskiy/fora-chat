...
function Message(props) {
  const { value, type, username, timestamp, isSticker } = props
  ...
  return (
    <div className="row message">
      <div className={messageBalloonClass}>
        ...
        <div className="message__text">{isSticker ? 
        <div className="message__sticker" style={{backgroundImage: value}}></div>
        : value}</div>
